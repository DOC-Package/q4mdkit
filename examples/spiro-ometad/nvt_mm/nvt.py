...
from qm4d4crystal.qmmm.md_config import get_md_config
import mdtraj as md
...
input_pdb = "../input/spiro-ometad_opt.pdb"
...
# For MM-only runs, use the OpenMM theory directly and skip creating QM/DFTB objects.
qmmm = omm
