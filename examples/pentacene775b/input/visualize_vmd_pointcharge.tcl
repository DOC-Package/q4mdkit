...
# Usage: vmd -e /home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/visualize_vmd_pointcharge.tcl

# Load structure
mol new /home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/pentacene_qmmm.pdb type pdb waitfor all
...
# ============================================================
proc save_viewpoint {{filename "/home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/viewpoint.tcl"}} {
...
proc load_viewpoint {{filename "/home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/viewpoint.tcl"}} {
...
if {[file exists "/home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/viewpoint.tcl"]} {
    load_viewpoint
    puts "Auto-loaded viewpoint from /home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/viewpoint.tcl"
}
...
puts "  save_viewpoint           - Save current view to /home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/viewpoint.tcl"
puts "  load_viewpoint           - Load view from /home/takahashi/python/qm4d4crystal/examples/pentacene775b/input/viewpoint.tcl"
