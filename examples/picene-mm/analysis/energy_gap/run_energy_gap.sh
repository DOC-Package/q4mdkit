...
charged_prmtop="$example_dir/input/picene_cation.prmtop"
trajectory="$example_dir/nvt-mm/output/nvt.dcd"
output="$example_dir/analysis/energy_gap/energy_gap.csv"
resid=202
start=0
stop=""
stride=1
...
Run compute_energy_gap.py for the picene Amber/OpenMM trajectory.
...
Options:
  ...
  --resid N                   1-based target residue (default: 202)
  --start N                   First frame (default: 0)
  --stop N                    Exclusive final frame (default: all frames)
  --stride N                  Frame stride (default: 1)
  --time-origin-ps VALUE      Time of frame 0 (default: 0.05)
  --time-step-ps VALUE        Saved-frame interval (default: 0.05)
