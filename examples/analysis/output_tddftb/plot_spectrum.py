#!/usr/bin/env python3
"""Plot TD-DFTB absorption spectrum."""
...
# Energy plot (1-3 eV range)
plot_mask = (energy >= 1.0) & (energy <= 3.0)
...
ax1.set_title('TD-DFTB Absorption Spectrum (Pentacene dimer)', fontsize=14)
ax1.legend()
ax1.set_xlim(1.0, 3.0)
ax1.grid(True, alpha=0.3)

# Wavelength plot (400-1200 nm range)
plot_mask2 = (wavelength >= 400) & (wavelength <= 1200) & np.isfinite(wavelength)
