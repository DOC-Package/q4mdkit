...
def main():
    ...
    # Files to compare
    files = {
        'all': 'energy_diff_all.dat',
        '500': 'energy_diff_500.dat',
        '1500': 'energy_diff_1500.dat',
    }
    ...
    # Plot 500 and 1500 first (lines), then all on top (dashed)
    for key in ['500', '1500']:
