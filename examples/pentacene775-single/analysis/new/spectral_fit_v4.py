#!/usr/bin/env python3
"""
v4: Stage 1の残差をモード14, 15, 16の4次相関でフィット

Stage 1: Linear terms with NNLS (c_k ≥ 0)
Stage 2: モード14, 15, 16の全4次相関ペア(6組)で非線形最小二乗フィット
  - 4次相関: <δ(q_i(t)q_j(t)) * δ(q_i(0)q_j(0))> (i,j ∈ {14,15,16})
  - 係数は d² (非線形)
"""
import numpy as np
...
print("="*70)
print("v4: Stage 1残差をモード14,15,16の4次相関でフィット")
print("="*70)
...
# ============================================================================
# Stage 2: モード14,15,16の4次相関をフィット
# ============================================================================
print("\n" + "="*70)
print("Stage 2: モード14,15,16の4次相関をフィット")
print("="*70)
...
cache_file_v4 = 'spectral_cache_v4_14_16.npz'

# ペアのリスト
pairs = [(14,14), (14,15), (14,16), (15,15), (15,16), (16,16)]
pair_names = ['(14,14)', '(14,15)', '(14,16)', '(15,15)', '(15,16)', '(16,16)']
q_dict = {14: q14, 15: q15, 16: q16}
...
plt.tight_layout()
plt.savefig('spectral_fit_v4.png', dpi=150, bbox_inches='tight')
print("Saved: spectral_fit_v4.png")
plt.close()
