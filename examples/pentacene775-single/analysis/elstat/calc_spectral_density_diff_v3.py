...
def main():
    ...
    print(f"\nReorganization energies:")
    print(f"  λ_total = {lambda1:.2f} cm⁻¹ = {lambda1*cm_to_meV:.2f} meV")
    print(f"  λ_external = {lambda2:.2f} cm⁻¹ = {lambda2*cm_to_meV:.2f} meV")
    print(f"  λ_internal = {lambda_diff:.2f} cm⁻¹ = {lambda_diff*cm_to_meV:.2f} meV")
    print(f"  λ_cross1 (int, ext) = {lambda_cross1:.2f} cm⁻¹ = {lambda_cross1*cm_to_meV:.2f} meV")
    print(f"  λ_cross2 (ext, int) = {lambda_cross2:.2f} cm⁻¹ = {lambda_cross2*cm_to_meV:.2f} meV")
    print(f"  λ_external + λ_internal + λ_cross1 + λ_cross2 = {(lambda2 + lambda_diff + lambda_cross1 + lambda_cross2)*cm_to_meV:.2f} meV")
