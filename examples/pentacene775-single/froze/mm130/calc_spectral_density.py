...
def main():
    ...
    parser.add_argument('--molecules', '-m', type=str, default='89,126,127,130,159,167,195,197,207,250',
                        help='Comma-separated list of molecule IDs to plot (default: 89,126,127,130,159,167,195,197,207,250)')
