...
def main():
    ...
    output_prefix = "filtered_traj600"
    
    # Parse modes to remove
    #modes_to_remove = parse_mode_list(args.modes)
    #modes_to_remove = list(range(22, 30)) # 520
    #modes_to_remove = list(range(76, 86)) # 1500
    #modes_to_remove = list(range(34, 51)) # 790 35-51
    #modes_to_remove = list(range(37, 46)) # 800 38-46
    #modes_to_remove = list(range(37, 57)) # 750-1000 38-57
    #modes_to_remove = list(range(6, 38)) # 0-750
    #modes_to_remove = list(range(87, 94)) # 1750 88-94
    modes_to_remove = list(range(24, 38)) # 600 25-38
