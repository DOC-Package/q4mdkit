...
screen -dmS $SESSION_NAME -L -Logfile "nvtsc.log" bash -c "$COMMAND; echo '--------------------------------'; echo 'Job finished. Press Enter to close.'; read"

echo "=================================================="
echo "Job started in screen session: $SESSION_NAME"
echo "Log file: minimization_screen.log"
echo "=================================================="
