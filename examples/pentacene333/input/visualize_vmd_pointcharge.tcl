...
# Usage: vmd -e /home/takahashi/python/q4mdkit/examples/pentacene333/input/visualize_vmd_pointcharge.tcl

# Load structure
mol new /home/takahashi/python/q4mdkit/examples/pentacene333/input/pentacene_qmmm.pdb type pdb waitfor all
...
# ============================================================
proc save_viewpoint {{filename "/home/takahashi/python/q4mdkit/examples/pentacene333/input/viewpoint.tcl"}} {
...
proc load_viewpoint {{filename "/home/takahashi/python/q4mdkit/examples/pentacene333/input/viewpoint.tcl"}} {
...
if {[file exists "/home/takahashi/python/q4mdkit/examples/pentacene333/input/viewpoint.tcl"]} {
    load_viewpoint
    puts "Auto-loaded viewpoint from /home/takahashi/python/q4mdkit/examples/pentacene333/input/viewpoint.tcl"
}
...
puts "  save_viewpoint           - Save current view to /home/takahashi/python/q4mdkit/examples/pentacene333/input/viewpoint.tcl"
puts "  load_viewpoint           - Load view from /home/takahashi/python/q4mdkit/examples/pentacene333/input/viewpoint.tcl"
