...
input_mol2="$example_dir/input/pentacene_gaff2.mol2"
neutral_prmtop="$example_dir/input/pentacene.prmtop"
cation_mol2="$example_dir/input/pentacene_cation.mol2"
cation_prmtop="$example_dir/input/pentacene_cation.prmtop"
resid=156
net_charge=1
multiplicity=2
...
Options:
  ...
  --resid N               Target residue number, 1-based (default: 156)
...
temporary_mol2="$work_dir/pentacene_cation.mol2"
temporary_prmtop="$work_dir/pentacene_cation.prmtop"
orca_scaffold="$work_dir/pentacene_orca_scaffold.inp"
orca_input="$work_dir/pentacene_cation.inp"
orca_output="$work_dir/pentacene_cation.out"
am1_mol2="$work_dir/pentacene_am1.mol2"
am1_ac="$work_dir/pentacene_am1.ac"
bcc_ac="$work_dir/pentacene_bcc.ac"
antechamber_scaffold_command=(
    conda run -n amber antechamber
    -i "$input_mol2" -fi mol2
    -o "$orca_scaffold" -fo orcinp
    -at gaff2
    -nc "$net_charge" -m "$multiplicity" -rn PEN
    -an n -du n -seq n
)
